...
<div class="app-content content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="title">
                Departments <a href="{{Route('add_departments')}}"
                    ...
                    @foreach($departments as $department)
                        <tr>
                            ...
                            <td>
                                    ...
                                    <a href="{{Route('edit_departments',$department->id)}}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> </a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form method="POST" action="{{Route('delete_departments',$department->id)}}">
                                                @csrf
                                                @method('delete')
