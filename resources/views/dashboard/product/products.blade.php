                ...
                <table id="productstable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    @foreach($allproducts as $allproduct)
                        <tr>
                            ...
                            <td>{{$allproduct->company}}</td>
                            <td>{{$allproduct->email}}</td>
                            <td>{{$allproduct->phone}}</td>
                            <td>{{$allproduct->address}}</td>
                            <td>{{$allproduct->bank_name}}</td>
                            <td>
                            <a href="{{Route('view_product',$allproduct->id)}}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> </a>
                         <a href="{{Route('edit_product',$allproduct->id)}}" class="btn btn-sm btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="POST" action="{{Route('delete_product',$allproduct->id)}}">
                                        @csrf
                                        @method('delete')
