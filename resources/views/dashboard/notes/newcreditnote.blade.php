                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    ...
                                    <form method="get"" action="{{route('search_creditnote')}}">
                                ...
                                <form method="post"" action="{{Route('new_creditnotes_form')}}">
                                @csrf
                                <div id="customer">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invociedate" class="caption">Invoice Date</label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control " placeholder="Billing Date" name="invoicedate" data-toggle="datepicker" autocomplete="false">
                                        </div>
                                    </div>
