...
@section('title','New Customer Record')
@section('content')
                    ...
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    ...
                                    <form method="get"" action="{{route('search_customer_record')}}">
                                ...
                                <form method="post"" action="{{route('new_customer_record_form')}}">
                                @csrf
                                <div id="customer">
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invocieno" class="caption">Cutomer Number</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-file-text-o" aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" placeholder="customer number #" name="customernumber" value="1010">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invociedate" class="caption">Customer Date</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-calendar4" aria-hidden="true"></span></div>
                                            <input type="date" class="form-control " placeholder="Billing Date" name="customerdate" data-toggle="datepicker" autocomplete="false">
                                        </div>
                                    </div>
