...
@section('titlee','Customer Record View')
@section('content')
                    ...
                    <div class="">
                            ...
                            <span
                                ...
                                <div class="dropdown-menu"><a href="#sendEmail" data-toggle="modal"
                                                              ...
                                                              data-type="notification">Cutomer Record Notification</a>
                            ...
                            <span
                                ...
                                <div class="dropdown-menu"><a href="#sendSMS" data-toggle="modal"
                                                              ...
                                                              data-type="notification">Customer Notification</a>
                                    <div class="dropdown-divider"></div>
