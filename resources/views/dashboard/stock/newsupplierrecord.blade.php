...
@section('title','New Supplier Record')
@section('content')
                    ...
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    ...
                                    <form method="get"" action="{{route('search_supplier_record')}}">
                                ...
                                <form method="post"" action="{{route('new_supplier_record_form')}}">
                                @csrf
                                <div id="customer">
                                @php if(isset($posts)) {   @endphp
                                    ...
                                    <div class="clientinfo">
                                         Supplier Details                                       
                                          <hr>
                                        <input type="hidden" name="billing_name" value="{{$post->name}}">
                                        <div>{{$post->name}}</div>
                                    </div>
                                    <div class="clientinfo">
                                    <input type="hidden" name="billing_address" value="{{$post->address}}">
                                        <div>  {{$post->address}}</div>
                                    </div>
                                    <div class="clientinfo">
                                    <input type="hidden" name="billing_phone" value="{{$post->phone}}">
                                        <div>  {{$post->phone}}</div>
                                    </div>
                                    <div class="clientinfo">
                                    <input type="hidden" name="billing_email" value="{{$post->email}}">
                                        <div>  {{$post->email}}</div>
                                    </div>
                                    <hr>
                                    @endforeach
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invocieno" class="caption">Supplier Number</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-file-text-o" aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" placeholder="suppliernumber #" name="suppliernumber" value="1010">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invociedate" class="caption">Supplier Date</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-calendar4" aria-hidden="true"></span></div>
                                            <input type="date" class="form-control " placeholder="Billing Date" name="supplierdate" data-toggle="datepicker" autocomplete="false">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="toAddInfo"
                                               class="caption">Supplier Note</label>
                    ...
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="right" colspan="6"><input type="submit" class="btn btn-success sub-btn" value=" Generate Purches " data-loading-text="Creating...">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    Please leave Shipping Address blank if you do not want to print it on the Purches.                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"
