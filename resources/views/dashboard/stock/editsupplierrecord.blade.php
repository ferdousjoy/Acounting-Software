                    ...
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <form method="post"" action="{{route('edit_supplier_record_form')}}">
                                @csrf
                                @method('put')
                                <div id="customer">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invocieno" class="caption">Supplier  Number</label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Invoice #" name="suppliernumber" value="{{$editsupplier->billing_supplier_no}}">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invociedate" class="caption">Purches Date</label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control " value="{{$editsupplier->billing_date}}"  placeholder="Billing Date" name="supplierdate"  autocomplete="false" value="{{$editsupplier->billing_invoice_no}}">
                                        </div>
                                    </div>
