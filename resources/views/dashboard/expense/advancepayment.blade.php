...
<div class="app-content content">
    ...
    <div class="card">
        <div class="card-header">
            <h4>Advance Payment Statement</h4>
            <hr>
...
<div class="card card-block">
    <div class="card-body">
        <form action="{{Route('add_advancepayment_form')}}" method="post" id="product_action" class="form-horizontal">
            @csrf
            <div class="grid_3 grid_4">
                <h6 class="w-100 text-center">Add New Advance Payment</h6>
                <hr>
