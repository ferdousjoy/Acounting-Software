...
<div class="app-content content">
    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            ...
            <p>&nbsp;</p>
            <div class="card card-block">
              <form action="{{Route('UpdateIncome2')}}" class="card-body"  method="post" accept-charset="utf-8">
                     @csrf
                  <div class="grid_3 grid_4">
                      <h6 class="w-100 text-center">Update Expenses</h6>
                      <hr>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                              <input type="text" class="form-control required" name="particular" id="date"
                                     data-toggle="datepicker" autocomplete="false"  value="{{$cash->particular}}" >
                          </div>
                      </div>
                      <div class="form-group row">
