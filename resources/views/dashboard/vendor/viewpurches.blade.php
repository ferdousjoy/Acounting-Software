            ...
            <div id="invoice-template" class="card-body">
                <div class="row">
                    ...
                    <div class="">
                            ...
                            <a href="{{Route('edit_purches',$view->id)}}" class="btn btn-warning mb-1"><i
                                        class="fa fa-pencil"></i> Edit Purches</a>
                            ...
                            <span
                                ...
                                <div class="dropdown-menu"><a href="#sendEmail" data-toggle="modal"
                                                              ...
                                                              data-type="notification">Purches Notification</a>
                ...
                <div id="invoice-customer-details" class="row pt-2">
                    ...
                    <div class="offset-md-3 col-md-3 col-sm-12 text-xs-center text-md-left">
                        <p><span class="text-muted">Purches Date  :</span> {{$view->billing_date}}</p> 
...
1. 10% discount if payment received within ten days otherwise payment 30 days after Purches date
