              ...
              <div class="row">
                <div class="col-sm-12">
                  <div id="customerpanel" class="inner-cmp-pnl">
                    ...
                    <form id="invoiceForm" method="post" action="{{Route('new_invoice_form')}}">
                    @csrf
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group row">
                            ...
                            <div class="col-md-8"><input type="text" name="chalan_number" class="form-control" value="{{$challan_number+1}}"></div>
                          </div>
                        </div>
