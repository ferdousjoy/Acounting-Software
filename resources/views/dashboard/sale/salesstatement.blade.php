        ...
        <div class="card-body">
            <div class="col-md-6">
                <ul class="list-unstyled">
                    <li class="font-large-x1 blue ">Total Sales                        <span id="p1" class="font-large-x1 red float-xs-right"><i
                                    class=" icon-refresh spinner"></i></span>
                    </li>
                    <hr>
                    <li class="font-large-x1 green">Total Month Sales                        <span id="p2" class="font-large-x1 blue float-xs-right"><i
