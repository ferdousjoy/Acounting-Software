                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-block sameheight-item">
                            ...
                            <form action=" export/transactions_o" method="post" role="form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="pay_acc" class="form-control">
                                            ...
                                            <option value='1'>123456 - Sales Account</option>                                            <option value='All'>All Accounts</option>
                                        </select>
