        ...
        <div class="card-body">
            ...
            <table id="doctable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
              ...
              <tr>
                  ...
                  <td>{{$key->amount}}</td>
                  <td>
              <a href="{{ url('editincome/'.$key->id) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
              <a class="btn btn-danger btn-sm" href="{{Route('delete_pos_invoices22',$key->id)}}" > <i class="fa fa-trash"></i> </a>
