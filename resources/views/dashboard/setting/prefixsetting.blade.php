            ...
            <div class="card-body">
                <form method="post" id="product_action" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix">Quote Prefix</label>

                        <div class="col-sm-6">
                            <input type="text"
                                   class="form-control margin-bottom  required" name="q_prefix"
                                   value="QT#" maxlength="5">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix">Purchase Order Prefix</label>

                        <div class="col-sm-6">
                            <input type="text"
                                   class="form-control margin-bottom  required" name="p_prefix"
                                   value="PO#" maxlength="5">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix">Subscription Prefix</label>

                        <div class="col-sm-6">
                            <input type="text"
                                   class="form-control margin-bottom  required" name="r_prefix"
                                   value="SUB#" maxlength="5">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix">Stock Return Prefix</label>

                        <div class="col-sm-6">
                            <input type="text"
                                   class="form-control margin-bottom  required" name="s_prefix"
                                   value="SR#" maxlength="5">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix">Transactions Prefix</label>

                        <div class="col-sm-6">
                            <input type="text"
                                   class="form-control margin-bottom  required" name="t_prefix"
                                   value="TRN#" maxlength="5">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"
                               for="invoiceprefix">Others Prefix</label>
