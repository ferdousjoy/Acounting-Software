                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div class="col-md-6">    
                                    <div class="input-group">
                                            <input type="text" class="form-control" value="Bill" name="number">
                            ...
                            <div class="inner-cmp-pnl">
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                            <div class="row">
                                            <div class="col-md-4">
                                            <label for="invocieno" style="float:right" class="caption">Supplier</label>
                                            </div>
                                          <div class="col-md-6">
                                          <select name="" id="" class="selectpicker form-control">
                                          <option value="1">Digital Hub</option>
                                                <option value="1">HSBLCO</option>
                                                <option value="1">Digital Account</option>
                                            </select>
                                          </div>
                                            </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                            <div class="row">
                                            <div class="col-md-4">
                                            <label for="invocieno" style="float:right" class="caption">Expiry Date</label>
                                            </div>
                                          <div class="col-md-6">
                                    ...
                                    <div class="col-sm-4">
                                            <div class="row">
                                            <div class="col-md-4">
                                            <label for="invocieno" style="float:right" class="caption">Receive No</label>
                                            </div>
                                          <div class="col-md-6">
                                             <input type="text" class="form-control "  name="subheading" >
                                          </div>
