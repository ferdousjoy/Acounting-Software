            ...
            <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <form method="post"" action="{{route('edit_purches_form')}}">
                                @csrf
                                @method('put')
                                <div id="customer">
                                    <div class="clientinfo">
                                         Client Details                                       
                                          <hr>
                                        <input type="hidden" name="billing_name" value="{{$editpurches->billing_name}}">
                                        <div>{{$editpurches->billing_name}}</div>
                                    </div>
                                    <div class="clientinfo">
                                    <input type="hidden" name="billing_address" value="{{$editpurches->billing_address}}">
                                        <div>  {{$editpurches->billing_address}}</div>
                                    </div>
                                    <div class="clientinfo">
                                    <input type="hidden" name="billing_phone" value="{{$editpurches->billing_phone}}">
                                        <div>  {{$editpurches->billing_phone}}</div>
                                    </div>
                                    <div class="clientinfo">
                                    <input type="hidden" name="billing_email" value="{{$editpurches->billing_email}}">
                                        <div>  {{$editpurches->billing_email}}</div>
                                    </div>
                                    <hr>   
                                    <p>Warehouse</p>
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invocieno" class="caption">Purches Number</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-file-text-o" aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" placeholder="Invoice #" name="purchese_number" value="{{$editpurches->billing_purches_no}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6"><label for="invocieno" class="caption">Reference</label>
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span></div>
                                            <input type="text" class="form-control" placeholder="Reference #" name="refer" value="{{$editpurches->billing_reference}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invociedate" class="caption">Purches Date</label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control " value="{{$editpurches->billing_date}}"  placeholder="Billing Date" name="date"  autocomplete="false" value="{{$editpurches->billing_invoice_no}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6"><label for="invocieduedate"  class="caption">Next Payment After</label>
                                        <select name="nextpayment"  class="selectpicker form-control">
                                            <option selected value="{{$editpurches->billing_next_payment}}">{{$editpurches->billing_next_payment}}</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control round" name="tax"  id="taxformat">
                                            <option value="{{$editpurches->billing_tax}}"  selected>&raquo;On</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="discount"  id="discountFormat">
                                                <option selected value="{{$editpurches->billing_discount}}">{{$editpurches->billing_discount}}</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" name="notes" rows="2">{{$editpurches->billing_note}}</textarea></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tbody>
                            <tr>
                                <td><input type="text" class="form-control" value="{{$editpurches->product_name}}" name="product_name" placeholder="Enter Product name or Code"  id='productname-0'>
                                </td>
                                <td><input type="text" value="{{$editpurches->product_quantity}}" class="form-control req amnt" name="product_qty" id="amount-0" onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()" autocomplete="off" value="1"></td>
                                ...
                                <td><input type="text" class="form-control vat " value="{{$editpurches->billing__reference}}"  name="product_tax" id="vat-0" onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()" autocomplete="off"></td>
                            ...
                            <tr>
                                ...
                                <textarea id="dpid-0" class="form-control" name="product_description">
                                 {{$editpurches->billing_description}}
                                </textarea><br></td>
                            </tr>
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="2">Payment Currency for your client <small>based on live market</small>
                                    <select name="mcurrency" class="selectpicker form-control">
                                        <option selected value="{{$editpurches->payment_currency}}">Default</option>
                                ...
                                <td align="left" colspan="2"><input type="text" value="{{$editpurches->product_price}}" name="total" class="form-control"  >
                                </td>
                            </tr>
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="2"> Payment Terms <select name="pterms" class="selectpicker form-control">
                                    <option value="{{$editpurches->payment_terms}}">Payment On Receipt</option>
                                    </select></td>
                                ...
                                <input type="hidden"  value=" {{$editpurches->id}}" name="id" >
