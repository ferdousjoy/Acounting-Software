...
<div class="app-content content">
    ...
    <div class="card">
        <div class="card-content">
            ...
            <div id="view-template" class="card-body">
                <div class="row">
                    ...
                    <div class="">
                            ...
                            <a href="edit?id=26" class="btn btn-warning mb-1"><i
                                        class="fa fa-pencil"></i> Edit view</a>
                            ...
                            <span
                                ...
                                <div class="dropdown-menu"><a href="#sendEmail" data-toggle="modal"
                                                              ...
                                                              data-type="notification">view Notification</a>
                ...
                <div id="view-company-details" class="row mt-2">
                ...
                <div id="view-customer-details" class="row pt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                        <ul class="px-0 list-unstyled">
                            ...
                            <li class="text-bold-800"><strong  class="view_a">{{$view->billing_name}}</strong></li>
                            <li></li>
                            <li>{{$view->billing_address}}s</li>
                    ...
                    <div class="offset-md-3 col-md-3 col-sm-12 text-xs-center text-md-left">
                        <p><span class="text-muted">view Date  :</span> {{$view->billing_date}}</p> 
                      <p><span class="text-muted">Terms :</span> {{$view->payment_terms}}</p>                    </div>
                </div>
                <!--/ view Customer Details -->

                <!-- view Items Details -->
                <div id="view-items-details" class="pt-2">
                    <div class="row">
                ...
                <div id="view-footer"><p class="lead">Credit Transactions:</p>
                    <table class="table table-striped">
                        <thead>
                        <tr>
                            <th>Date</th>
...
1. 10% discount if payment received within ten days otherwise payment 30 days after view date
                    ...
                    <div class="row">
                        <div class="col mb-1"><label
                            ...
                            <input type="text" class="form-control"
                                   ...
                                   value="Payment for view #1012"></div>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" class="form-control required"
                               name="tid" id="viewid" value="26">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Cancel view</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-body">
                <form id="form_model">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default"
                                data-dismiss="modal"> Close</button>
                        <input type="hidden" id="action-url" value="views/update_status">
                        <button type="button" class="btn btn-primary"
