                                  ...
                                  <div class="col-sm-12 cmp-pnl">
                                      <div class="inner-cmp-pnl">
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-sm-4">
                                                  <div class="row">
                                                      <div class="col-md-4"><label for="challan_id" class="caption">Challan No</label></div>
                                                      <div class="col-md-6"><select name="chalan_no" id="challan_id" class="selectpicker form-control"></select></div>
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="form-group row">
