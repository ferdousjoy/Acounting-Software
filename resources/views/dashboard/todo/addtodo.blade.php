...
<div class="app-content content">
    ...
    <div class="card">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" class="form-horizontal" action="{{Route('addtodoform')}}">
                @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <textarea class="summernote"
                                  placeholder=" Note"
                                  autocomplete="false" rows="10" name="notes"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="submit"  class="btn btn-success margin-bottom"  value="Add Task" >
                        </div>
                    </div>
