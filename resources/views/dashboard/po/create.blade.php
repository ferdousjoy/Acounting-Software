    ...
    <div class="content-body">
      <div class="card">
        <div class="card-content">
          ...
          <div class="card-body">
            <form id="invoicesForm" method="post" action="{{route('pos.store')}}">
              @csrf
              <div class="row">
                 <div class="col-sm-12">
                   <div id="customerpanel" class="inner-cmp-pnl">
                      ...
                      <div class="col-sm-4">
                        <div class="row" style="transform:translateX(-29px);">
                          ...
                          <div class="col-md-6">
                             <input type="text" class="form-control" name="po_no" style="margin-bottom:17px;border:1px solid #babfc7;padding:10px;border-radius:4px;">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <select name="shipping_address" id="shipping_address" class="selectpicker form-control"></select>
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-4">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <input type="date" class="form-control"  name="po_date" data-toggle="datepicker" value="{{ date('m/d/Y') }}" autocomplete="false">
                          </div>
                        </div>
                      </div>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <input type="date" class="form-control"  name="po_exdate" data-toggle="datepicker" value="{{ date('m/d/Y') }}" autocomplete="false">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <textarea cols="25" rows="3" name="notes" style="resize:none; border-radius:2px;border-color:#e4e4e4;"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
