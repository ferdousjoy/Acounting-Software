...
class CreateCreditnotesModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('creditnotes_models', function (Blueprint $table) {
            ...
            $table->string('billing_creditnote_no');
    ...
    {
        Schema::dropIfExists('creditnotes_models');
    }
}
