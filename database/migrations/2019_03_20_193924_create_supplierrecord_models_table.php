...
class CreateSupplierrecordModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('supplierrecord_models', function (Blueprint $table) {
            ...
            $table->string('billing_supplier_no');
    ...
    {
        Schema::dropIfExists('supplierrecord_models');
    }
}
